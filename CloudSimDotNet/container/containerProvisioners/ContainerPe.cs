namespace org.cloudbus.cloudsim.container.containerProvisioners
{
	...
	public class ContainerPe
	{
		...
		/// <param name="containerPeProvisioner"> the pe provisioner
		/// @pre id >= 0
		...
		{
			Id = id;
            ContainerPeProvisionerProperty = containerPeProvisioner;
		...
		{
            ContainerPeProvisionerProperty.Mips = d;
		}
        ...
        //public virtual int getMips()
        public virtual int Mips
        {
            get
            {
                return (int)ContainerPeProvisionerProperty.Mips;
            }
        }
        ...
        public virtual ContainerPeProvisioner ContainerPeProvisionerProperty
        {
            get
            {
            ...
            set
            {
                this.containerPeProvisioner = value;
            }
        }
    }
}