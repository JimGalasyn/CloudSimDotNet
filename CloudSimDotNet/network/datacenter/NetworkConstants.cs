...
namespace org.cloudbus.cloudsim.network.datacenter
{
	...
	/// The exceptions are the  <seealso cref="TaskStage"/> types and number of
	/// switches by level.
	/// </summary>
	public class NetworkConstants
	{
		...
		/// <summary>
		/// Types of <seealso cref="TaskStage"/>
		/// @todo should be an enum
		/// </summary>
		public const int EXECUTION = 0;
		public const int WAIT_SEND = 1;
		public const int WAIT_RECV = 2;
		public const int FINISH = -2;

		/// <summary>
		/// Number of switches at root level. </summary>
		public const int ROOT_LEVEL = 0;
			/// <summary>
			/// Number of switches at aggregation level. </summary>
		public const int Agg_LEVEL = 1;
			/// <summary>
			/// Number of switches at edge level. </summary>
		public const int EDGE_LEVEL = 2;

		public const int PES_NUMBER = 4;
		public const int FILE_SIZE = 300;
		public const int OUTPUT_SIZE = 300;

		public const int COMMUNICATION_LENGTH = 1;
