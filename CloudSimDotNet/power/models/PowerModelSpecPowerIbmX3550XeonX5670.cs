...
namespace org.cloudbus.cloudsim.power.models
{
	...
	/// </summary>
	public class PowerModelSpecPowerIbmX3550XeonX5670 : PowerModelSpecPower
	{
		/// <summary>
		/// The power consumption according to the utilization percentage. </summary>
		/// <seealso cref= #getPowerData(int)  </seealso>
		private readonly double[] power = new double[] {66, 107, 120, 131, 143, 156, 173, 191, 211, 229, 247};
