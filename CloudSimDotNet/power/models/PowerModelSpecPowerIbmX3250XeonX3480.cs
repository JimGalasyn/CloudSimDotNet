...
namespace org.cloudbus.cloudsim.power.models
{
	...
	/// </summary>
	public class PowerModelSpecPowerIbmX3250XeonX3480 : PowerModelSpecPower
	{
		/// <summary>
		/// The power consumption according to the utilization percentage. </summary>
		/// <seealso cref= #getPowerData(int)  </seealso>
		private readonly double[] power = new double[] {42.3, 46.7, 49.7, 55.4, 61.8, 69.3, 76.1, 87, 96.1, 106, 113};
