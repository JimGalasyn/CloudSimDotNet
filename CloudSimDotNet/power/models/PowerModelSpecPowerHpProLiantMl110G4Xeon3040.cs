...
namespace org.cloudbus.cloudsim.power.models
{
	...
	/// </summary>
	public class PowerModelSpecPowerHpProLiantMl110G4Xeon3040 : PowerModelSpecPower
	{
		/// <summary>
		/// The power consumption according to the utilization percentage. </summary>
		/// <seealso cref= #getPowerData(int)  </seealso>
		private readonly double[] power = new double[] {86, 89.4, 92.6, 96, 99.5, 102, 106, 108, 112, 114, 117};
