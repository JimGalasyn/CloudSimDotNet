...
namespace org.cloudbus.cloudsim.util
{
	...
	/// jobs (<seealso cref="Cloudlet Cloudlets"/>) that can be dispatched to a resource by <seealso cref="Workload"/>.
	/// 
	...
	public interface WorkloadModel
	{
		...
		/// <summary>
		/// Generates a list of jobs (<seealso cref="Cloudlet Cloudlets"/>) to be executed.
		/// </summary>
		/// <returns> a list with the jobs (<seealso cref="Cloudlet Cloudlets"/>) 
